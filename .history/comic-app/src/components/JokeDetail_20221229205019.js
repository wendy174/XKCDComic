...
function JokeDetail() {
    ...
    return (
        <>
            <Hero title={ joke.title } image={"https://logo.clearbit.com/xkcd.com"} description="xkcd is an old, famous comic strip that has been around for years. We hope you enjoy these!"/>
