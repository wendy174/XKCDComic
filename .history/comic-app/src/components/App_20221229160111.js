  ...
  return (
    <div className="App">
      ...
      <Route strict path="/home">
        <Hero title="xcomics" image={"https://logo.clearbit.com/xkcd.com"} description="xkcd is an old famous comic strip that has been around for years. We hope you enjoy these!"/>
        <Main jokes={ jokes }/>
      </Route>
