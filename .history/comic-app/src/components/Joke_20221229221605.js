        ...
        <>
            <div className="p-5 text-bg-dark rounded-3">
                ...
                <div className="gap-2 d-sm-flex">
                    {isFavorited ? <button className="btn btn-warning" type="button" onClick={ unfavoriteHandler }>Unfavorite</button> : <button className="btn btn-warning" type="button" onClick={ favoriteHandler }>Unfavorite</button>}
