...
function JokeDetail() {
    ...
    function handlePostComment(e) {
        ...
        const newCommentObj = {
            id: comicComments.length + 1,
            text: newComment
        };

        const newComments = [...comicComments, newCommentObj];
        ...
        return (
            <div key={ comment.id }>
                <div>
                    ...
                    <button className="btn btn-outline-secondary" onClick={() => handleDeleteComment(comment.id) }type="button">Delete</button>
                </div>
                <br></br>
            </div>
        );
