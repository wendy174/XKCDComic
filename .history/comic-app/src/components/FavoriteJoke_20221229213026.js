    ...
    return (
        <>
            <div className="p-5 text-bg-dark rounded-3">
                ...
                <img src={ favorite.img } alt={ favorite.transcript } style={{ width: "100%", margin: "30px 0" }} className="img-thumbnail" />
                <br></br>
                <br></br>
                <p><b>Comic's Note:</b> { favorite.alt }</p>
                <div className="gap-2 d-sm-flex">
                    <button className="btn btn-warning" type="button">Unfavorite</button>
